...
TEST(SetRowsColsMatrixTest, SetRowsColsMatrices) {
  S21Matrix mat;
  mat.SetRowsCols(3, 3);
  EXPECT_EQ(mat(1, 1), 0);
}
...
int main(int argc, char **argv) {
  // // // ПРОВЕРЯЕМ ВЫВОД МАТРИЦЫ(--int argc, char **argv--тоже нужно кинуть в
  // // // комент)
  ...
  // // // THISSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS
  ...
  // // // OR THISSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSSS

  // // S21Matrix mat3 = S21Matrix(2, 2);
